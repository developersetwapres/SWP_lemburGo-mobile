...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _login() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          widget.controller.errorMessage ?? 'Login belum berhasil.',
        ),
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Masuk untuk mencatat laporan lembur Anda dengan lebih mudah.',
...
class _PrivacyNote extends StatelessWidget {
  ...
  Widget build(BuildContext context) => const Row(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Icon(Icons.verified_user_outlined, color: AppColors.muted, size: 18),
      SizedBox(width: 8),
      Expanded(
        child: Text(
          'Akses Anda diamankan. Password tidak pernah disimpan di perangkat.',
